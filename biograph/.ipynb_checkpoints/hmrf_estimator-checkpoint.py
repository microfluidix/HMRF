...
class hmrf():
    ...
    def energy(self,
        ...
        return self.gamma*int(cell_type==new_lat) + np.sum([int(lat_neighbour==new_lat) for lat_neighbour in latent_cell_type_props])
    ...
    def update_latent_celltype(self):
        ...
        for node in self.graph.nodes:
            ...
            latent_cell_type_props = [latent_cell_type_dict[n] for n in G.neighbors(node)]
